...
export default function ButtonGoogleLogin() {
    ...
    return (
        <>
            <button type="button" onClick={handleGoogleLogin} className="btn bg-white text-black border-[#e5e5e5] rounded-full flex items-center justify-center sm:w-11 sm:h-11 lg:w-12 lg:h-12 p-3">
